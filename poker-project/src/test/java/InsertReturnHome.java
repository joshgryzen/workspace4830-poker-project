...
public class InsertReturnHome {
  ...
  public void setUp() throws Exception {
    driver = new ChromeDriver();    baseUrl = "https://www.google.com/";
    driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(60));
    js = (JavascriptExecutor) driver;
  }

  @Test
  public void testInsertReturnHome() throws Exception {
    ...
    driver.findElement(By.name("hand")).sendKeys("AH+KH");
...
//    driver.get("http://localhost:8080/poker-project/home.jsp");
    assertTrue(driver.findElement(By.cssSelector("header")).getText().contains("Home Page"));
  }
